    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm font-medium text-slate-500">Pantau status stasiun, inventori baterai, dan performa keuangan SPBKLU Anda.</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card 
          ...
          icon={Battery} 
          description="Siklus pengisian aktif" 
          trend="Sehat" 
          color="purple"
        />
        <Card 
          ...
          icon={DollarSign} 
          description="Pendapatan swap flat" 
          trend="+32.4%" 
          color="emerald"
        />
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-xs font-semibold text-slate-400">Total akumulasi biaya penukaran baterai (Rupiah)</p>
            </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
          <div className="mb-6">
            <h4 className="text-base font-black text-slate-800 tracking-tight">Volume Penukaran</h4>
            <p className="text-xs font-semibold text-slate-400">Jumlah transaksi swap per bulan</p>
          </div>
